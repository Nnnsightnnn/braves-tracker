...
export const PLAYERS = [
  ...
  },
  {
    ...
    stats: { avg: .299, obp: .372, slg: .637, ops: 1.009, hr: 17, rbi: 43, sb: 0, bb: 18, so: 42, games: 46, doubles: 3 },
    statNote: "WALK-OFF-CLASS GO-AHEAD HR #17 BEATS TORONTO — Olson broke a 3-3 tie in the 6th Tuesday night, barely clearing the right-field wall off the Blue Jays for his MLB-/NL-leading 17th homer to lift Atlanta to a 4-3 win and baseball's best record at 41-20. The solo shot pushes his line to .299/.372/.637 (1.009 OPS), 17 HR / 43 RBI across 46 G — still the NL HR and FanGraphs WAR leader, the relentless middle-of-the-order anchor as the Braves keep stacking wins.",
    form: 9.7,
    status: "active",
    injuryNote: null,
  ...
  },
  {
    ...
    statNote: "STARTS TONIGHT vs TORONTO (WED 7:15 PM ET) — Holmes draws the middle game of the Blue Jays homestand series at Truist Park on regular rest, opposite Toronto LHP Patrick Corbin (2-1, 3.65). The season line sits at 3-2 / 3.77 ERA / 1.35 WHIP across 10 starts, with the staff 8-2 in his outings. He's looking to build on his career-high 10-K effort against Washington and keep Atlanta's MLB-best run going behind Olson's hot bat.",
    form: 8.6,
    status: "active",
    injuryNote: null,
...
export const UPCOMING_SCHEDULE = [
  {
    ...
    oppSP: { name: "Patrick Corbin", record: "2-1", era: 3.65, hand: "L" },
    note: "Game 2 vs Toronto at Truist Park · Holmes on regular rest after his career-high 10-K outing vs Washington · opposite Blue Jays LHP Patrick Corbin (2-1, 3.65) · Atlanta took the opener 4-3 on Olson's HR #17",
  },
  {
    date: "2026-06-04",
    weekday: "Thu",
    ...
    home: true,
    venue: "Truist Park",
    atlSP: { id: "sale", name: "Chris Sale", record: "8-3", era: 2.02, daysRest: 7, hand: "L" },
    oppSP: { name: "TBD", record: null, era: null, hand: null },
    note: "Series finale vs Toronto (day game) · Sale lines up after his 8-K Fenway homecoming win · Blue Jays starter TBD",
  },
  {
    date: "2026-06-05",
    weekday: "Fri",
...
export const NEXT_GAME = {
  ...
  probables: {
    ...
    opp: { pitcher: "Patrick Corbin", record: "2-1", era: 3.65 },
  },
  note: "TONIGHT 7:15 PM ET — GAME 2 vs TORONTO — MLB-best Atlanta (41-20, .672, W1) goes for the series win at Truist Park after taking the opener 4-3 Tuesday on Matt Olson's go-ahead HR (#17) and Bryce Elder's bounce-back start. GRANT HOLMES (3-2, 3.77 ERA) takes the ball opposite Blue Jays LHP PATRICK CORBIN (2-1, 3.65 ERA). Watch list: the catching corps is still thin with Baldwin (oblique, eyeing a mid-June return) and Murphy (finger, hopeful by the All-Star break) on the IL and a León / Tromp tandem behind the plate; the NL East lead sits at 10.0 games. Sale lines up to follow in the finale.",
};
...
export const NL_EAST_STANDINGS = [
  { team: "ATL", name: "Atlanta Braves",         w: 41, l: 20, pct: .672, gb: 0,    streak: "W1" },
  { team: "WSH", name: "Washington Nationals",   w: 31, l: 30, pct: .508, gb: 10.0, streak: "W1" },
  { team: "PHI", name: "Philadelphia Phillies",  w: 30, l: 29, pct: .508, gb: 10.0, streak: "L1" },
  { team: "MIA", name: "Miami Marlins",          w: 27, l: 34, pct: .443, gb: 14.0, streak: "L1" },
  { team: "NYM", name: "New York Mets",          w: 26, l: 34, pct: .433, gb: 14.5, streak: "W1" },
];

// ─── NEWS DIGEST — the recency-biased summary the skill refreshes daily ──────────
export const NEWS_DIGEST = {
  generatedAt: "2026-06-03T08:45:00-04:00",
  summary:
    "GAME DAY — BRAVES GO FOR THE SERIES WIN OVER TORONTO TONIGHT — MLB-best Atlanta (41-20, .672, W1) opened the Blue Jays homestand with a 4-3 win Tuesday on MATT OLSON's go-ahead HR (#17) and a bounce-back start from BRYCE ELDER (W, 5-3), and now sends GRANT HOLMES (3-2, 3.77) to the mound at 7:15 PM ET against Toronto LHP Patrick Corbin (2-1, 3.65) to try to lock up the series, with Sale lined up for the finale. RAISEL IGLESIAS is now a perfect 11-for-11 in saves with a 0.00 ERA. The division cushion grows to 10.0 games — Washington (31-30) and Philadelphia (30-29) are tied 10.0 back, Miami sits 14.0 back (27-34), and the Mets 14.5 back (26-34). Catching corps still thin: Baldwin (oblique) eyeing a mid-June return, Murphy (finger) hopeful by the All-Star break; Schwellenbach throwing, Waldrep on Florida-complex bullpens. Acuña remains in the lineup managing the left thumb bone bruise.",
  keyTopics: [
    { category: "result",      title: "Olson walks the lead — HR #17 beats Toronto 4-3",                                                 detail: "Matt Olson broke a 3-3 tie in the 6th Tuesday, barely clearing the right-field wall for his MLB-/NL-leading 17th homer to give Atlanta a 4-3 win and baseball's best record at 41-20. Bryce Elder bounced back with 6.2 strong innings and Raisel Iglesias worked around two singles in the 9th for save #11." },
    { category: "rotation",    title: "TONIGHT: Holmes goes for the series win vs Corbin",                                                detail: "Grant Holmes (3-2, 3.77) draws the 7:15 PM ET middle game against Blue Jays LHP Patrick Corbin (2-1, 3.65). Holmes is coming off a career-high 10-K effort vs Washington; the staff is 8-2 in his outings. Sale lines up for Thursday's finale." },
    { category: "standings",   title: "NL East: ATL 41-20, lead out to 10.0",                                                            detail: "Atlanta holds the best record in baseball and the largest division lead at 41-20 (.672). The cushion is 10.0 games, with Washington (31-30) and Philadelphia (30-29) tied for second, Miami 14.0 back (27-34), and the Mets 14.5 back (26-34)." },
    { category: "narrative",   title: "Iglesias stays perfect — 11-for-11 in saves, 0.00 ERA",                                           detail: "Raisel Iglesias nailed down save #11 in as many chances Tuesday and still hasn't allowed a run: 0.00 ERA, 0.51 WHIP across 13.2 IP, 16 K / 1 BB. The Dylan Lee → Iglesias bridge is the deepest, most reliable back end in the NL." },
    { category: "narrative",   title: "Olson atop the NL home-run race — #17",                                                          detail: "Matt Olson leads the NL in homers and FanGraphs WAR at 17 HR, his line around .299/.372/.637 (1.009 OPS) with 43 RBI — the steady middle-of-the-order anchor all season as Atlanta keeps stacking wins." },
    { category: "rotation",    title: "Elder rights the ship — 6.2 strong vs Toronto",                                                   detail: "Bryce Elder (W, 5-3) answered his 8-0 Fenway blow-up with 6.2 innings of 6-hit, 3-run ball Tuesday, the only damage a Kazuma Okamoto two-run homer. His ERA settles to 2.75 (1.16 WHIP, 64 K across 78.2 IP) — back among the staff's best marks." },
    { category: "injury",      title: "Baldwin eyeing mid-June, Murphy hopeful by All-Star break",                                       detail: "Alex Anthopoulos pegged Drake Baldwin (right oblique strain, 10-day IL) for a roughly mid-June return — possibly sooner, with little rehab needed. Sean Murphy (fractured left middle finger) is a longer wait: hopeful by the All-Star break, though it could stretch to the deadline. Sandy León / Chadwick Tromp keep splitting duties. Baldwin's frozen line: .312/.380/.569, 12 HR / 35 RBI." },
    { category: "injury",      title: "Acuña plays through left thumb bone bruise",                                                     detail: "Ronald Acuña Jr. remains in the lineup managing a left thumb bone bruise from May 21 (X-rays negative, day-to-day designation). He's pushed through it during a recent power surge and continues to bat leadoff in right field." },
    { category: "injury",      title: "Rehab roundup — Schwellenbach throwing, Waldrep on Florida bullpens",                             detail: "Spencer Schwellenbach (arthroscopic elbow) is into a throwing program targeting a late-June / July return. Hurston Waldrep (post-elbow surgery, 60-day IL) is throwing bullpens at the Florida complex with a June rehab-assignment target. AJ Smith-Shawver (Tommy John, 2025) and Danny Young (Tommy John, 2025) remain on the 60-day IL; Young could surface after the All-Star break." },
    { category: "milestone",   title: "Acuña's 39th career leadoff HR headlined a 5-in-4 surge",                                        detail: "Ronald Acuña Jr.'s franchise-record 39th career leadoff homer Sunday capped a stretch of five homers in four games — the Fenway grand slam, a leadoff shot, and back-to-back Cincinnati blasts — a reminder of his catalyst ceiling atop the order." },
    { category: "rotation",    title: "Sale anchors the staff — NL-leading strikeouts, 10-1 in his starts",                              detail: "Chris Sale (8-3) remains the rotation's anchor after his 8-K win in his charged Fenway return, where he won the 2018 World Series. His ~2.02 ERA, 0.87 WHIP and NL-leading strikeout total have Atlanta at 10-1 in his starts since the 2024 trade; he lines up for Thursday's finale vs Toronto." },
    { category: "narrative",   title: "Atlanta keeps the best record in baseball at 41-20",                                            detail: "The Braves' Tuesday win pushed them to 41-20 (.672), the top mark in MLB. A balanced attack and a lights-out back of the bullpen have kept Atlanta in firm control of the NL East through early June." },
  ],
  sources: [
