...
export const PLAYERS = [
  ...
  },
  {
    ...
    stats: { avg: .232, obp: .308, slg: .407, ops: .715, hr: 19, rbi: 52, sb: 2, bb: 12, so: 56, games: 116 },
    statNote: "SECOND STRAIGHT GAME DEEP: Riley crushed a 421-foot solo homer in the fourth inning Thursday against the Reds, his 19th, homering in back-to-back games as Atlanta led early in the home finale before a bullpen slip let Cincinnati escape with a 7-6 win. His bat keeps anchoring the middle of the order behind Matt Olson as the Braves head to Miami to close the regular season with the No. 3 seed locked in.",
    form: 8.6,
    status: "active",
    injuryNote: null,
  ...
  },
  {
    ...
    stats: { avg: .240, obp: .330, slg: .402, ops: .732, hr: 11, rbi: 38, sb: 1, bb: 9, so: 35, games: 98, doubles: 7 },
  ...
  },
  {
    ...
    stats: { era: 8.22, whip: 1.74, ip: 23.0, k: 18, bb: 10, w: 0, l: 3, games: 6, starts: 5 },
    statNote: "CHARGED WITH THE HOME-FINALE LOSS: Smith-Shawver (0-3) relieved Tyler Mahle in the sixth Thursday and served up a go-ahead two-run homer to Héctor Rodríguez that turned a 6-5 Atlanta lead into a 7-6 Reds win, though he was otherwise sharp. The 23-year-old remains bullpen depth rather than a rotation piece as Atlanta leans on Chris Sale, Grant Holmes, and Martín Pérez into October.",
    form: 2.0,
    status: "active",
    injuryNote: null,
  ...
  },
  {
    ...
    stats: { era: 4.40, whip: 1.23, ip: 147.1, k: 130, bb: 36, hr: null, w: 7, l: 10, games: 27, starts: 27 },
    statNote: "A RARE ROUGH TURN TO CLOSE THE HOME SLATE: Mahle got no decision but was tagged for five runs over five innings Thursday in the 7-6 home-finale loss to the Reds, his shakiest start since the Aug 3 trade from San Francisco. Atlanta staked him a 4-1 first-inning lead, but Eugenio Suárez's two-run single and solo homers by Elly De La Cruz and rookie Carlos Jorge pulled Cincinnati even before the bullpen let it slip. Even so, Mahle profiles as the No. 2 postseason starter behind Chris Sale. He is a free agent after 2026.",
    form: 8.6,
    status: "active",
    injuryNote: null,
