...
export const PLAYERS = [
  ...
  },
  {
    ...
    stats: { avg: .274, obp: .344, slg: .549, ops: .893, hr: 25, rbi: 58, sb: 0, bb: 21, so: 49, games: 60, doubles: 23 },
    statNote: "THE IRON MAN: Olson took the field Friday night at Busch Stadium for his 741st straight game as a Brave, passing Dale Murphy's franchise record of 740 (1981 to 1986). He has never missed a game in an Atlanta uniform. Counting his Oakland years, the streak reaches 869, dating to May 2, 2021, and ranks ninth all-time; he moves to eighth in mid-August if it holds. He still leads the majors with 25 home runs.",
    form: 9.6,
    status: "active",
    injuryNote: null,
  ...
  },
  {
    ...
    statNote: "ATLANTA'S ONLY RUN IN ST. LOUIS: Riley singled up the middle in the 5th Friday night to score Mike Yastrzemski, the lone Braves run in a 2-1 loss. It follows the home run that ended his long drought against the Mets, and while the average is still low, he is putting better swings on the ball in the run-up to the break.",
    form: 5.8,
    status: "active",
    injuryNote: null,
  ...
  },
  {
    ...
    stats: { era: 3.18, whip: 1.24, ip: 56.2, k: 51, bb: 13, hr: null, w: 4, l: 1, games: 12, starts: 8 },
    statNote: "ON THE BALL TONIGHT IN ST. LOUIS: Lopez (4-1, 3.18) makes his ninth start Saturday at Busch Stadium opposite Cardinals lefty Matthew Liberatore, with Atlanta needing a bounce-back after the rain-soaked 2-1 loss in the opener. Since rejoining the rotation he has looked like a genuine mid-rotation stabilizer behind Sale, and with Pérez on the IL his innings matter even more.",
    form: 6.5,
    status: "active",
    injuryNote: null,
  ...
  },
  {
    ...
    statNote: "OPTIONED TO GWINNETT: Atlanta sent Waldrep back to Triple-A on Friday, the corresponding move when Tyler Kinley came off the paternity list. It follows the Pittsburgh disaster on Tuesday, when Ryan O'Hearn hit two of his three home runs off him (a first-inning grand slam and a third-inning solo shot) in a 7-run, 5-walk, 3.1-inning outing. With Pérez due back after the break, Waldrep resets at Gwinnett rather than holding a rotation spot he had not earned.",
    form: 3.0,
    status: "active",
    injuryNote: null,
...
export const UPCOMING_SCHEDULE = [
  {
    ...
    atlSP: { id: "lopez", name: "Reynaldo López", record: "4-1", era: 3.18, daysRest: 4, hand: "R" },
    oppSP: { name: "Matthew Liberatore", record: "4-6", era: 5.34, hand: "L" },
    note: "Middle game of the pre-break set in St. Louis, with Atlanta needing a bounce-back after Friday's rain-soaked 2-1 loss. Reynaldo López (4-1, 3.18) makes his ninth start against Cardinals lefty Matthew Liberatore (4-6, 5.34), who struck out nine against the Braves at Truist Park on June 30.",
  },
  {
    date: "2026-07-12",
    weekday: "Sun",
    ...
    note: "First-half finale in St. Louis before the All-Star break. Probables not yet announced.",
  },
];
...
export const NEXT_GAME = {
  ...
  tv: "BravesVision",
  probables: {
    atl: { pitcher: "Reynaldo López", record: "4-1", era: 3.18 },
    opp: { pitcher: "Matthew Liberatore", record: "4-6", era: 5.34 },
  },
  note: "LOPEZ TRIES TO EVEN THE SET AFTER A RAIN-SOAKED LOSS. REYNALDO LOPEZ (4-1, 3.18) takes the ball for the 7:15 PM ET middle game at Busch Stadium against Cardinals lefty MATTHEW LIBERATORE (4-6, 5.34), who struck out nine against Atlanta at Truist Park on June 30. The Braves lost Friday's opener 2-1 in a game that stretched past midnight through a 2-hour, 44-minute rain delay: Chris Sale had five strikeouts in three scoreless before the tarp came out, Austin Riley's fifth-inning single scored Mike Yastrzemski for the only Atlanta run, and Jimmy Crooks broke a 1-1 tie with an eighth-inning homer off Danny Young. The night's real story was MATT OLSON, who played his 741st straight game to pass Dale Murphy for the franchise record. At 54-39, Atlanta leads Philadelphia and Miami (both 52-43) by 3.0. IL watch: RONALD ACUNA JR. (hamstring) is lined up to open a rehab assignment during the break, MARTIN PEREZ (forearm) and ROBERT SUAREZ (forearm) both after the break, SPENCER STRIDER (60-day, elbow) toward mid-August, SEAN MURPHY (60-day, finger) around July 17.",
};
...
export const NL_EAST_STANDINGS = [
  { team: "ATL", name: "Atlanta Braves",         w: 54, l: 39, pct: .581, gb: 0,    streak: "L1" },
  { team: "PHI", name: "Philadelphia Phillies",  w: 52, l: 43, pct: .547, gb: 3.0,  streak: "L1" },
  { team: "MIA", name: "Miami Marlins",          w: 52, l: 43, pct: .547, gb: 3.0,  streak: "L1" },
  { team: "WSH", name: "Washington Nationals",   w: 48, l: 47, pct: .505, gb: 7.0,  streak: "L1" },
  { team: "NYM", name: "New York Mets",          w: 40, l: 54, pct: .426, gb: 14.5, streak: "L1" },
];
...
export const NEWS_DIGEST = {
  generatedAt: "2026-07-11T09:15:00-04:00",
  summary:
    "OLSON BECOMES THE IRON MAN, BUT THE CARDINALS TAKE THE OPENER. Friday night at Busch Stadium belonged to Matt Olson, who played in his 741st consecutive game and passed Dale Murphy for the Braves' franchise record, a mark Murphy set between 1981 and 1986. Olson has never missed a game in an Atlanta uniform; counting his Oakland years, the streak reaches 869 and ranks ninth all-time. The baseball around it was less kind. Rain stopped play for 2 hours and 44 minutes, the game did not finish until early Saturday, and St. Louis won 2-1. Chris Sale struck out five in three scoreless before the tarp came out and took a no-decision. Austin Riley's fifth-inning single scored Mike Yastrzemski for Atlanta's only run, Jordan Walker tied it in the 6th, and Jimmy Crooks, in the game as a defensive replacement, drove a Danny Young pitch 405 feet into the right-center bleachers in the 8th. The Braves fall to 54-39, still 3.0 clear of Philadelphia and Miami (both 52-43). Reynaldo López (4-1, 3.18) goes Saturday at 7:15 PM ET opposite Cardinals lefty Matthew Liberatore (4-6, 5.34). Hurston Waldrep was optioned to Triple-A Gwinnett after his rough spot start, and Ronald Acuña Jr. remains on track to open a rehab assignment during the All-Star break.",
  keyTopics: [
    { category: "milestone", title: "Olson passes Dale Murphy: 741 straight games", detail: "Matt Olson played in his 741st consecutive game Friday at Busch Stadium, one more than Dale Murphy's franchise record set from 1981 to 1986. He has not missed a game as a Brave; his overall streak, dating to May 2, 2021 with Oakland, stands at 869 and ranks ninth all-time.", recency: "today", art: { imageUrl: "/braves-tracker/assets/cover/2026-07-11-olson-iron-man.jpg", alt: "Matt Olson takes the field for his 741st straight game, passing Dale Murphy to become the Braves' Iron Man.", credit: "TRACKER PHOTO DESK" } },
    { category: "result", title: "Cardinals 2, Braves 1: Crooks ends a rain-soaked night", detail: "Jimmy Crooks, who entered in the 7th as a defensive replacement, broke a 1-1 tie with a 405-foot homer off Danny Young (0-1) in the 8th. The game ran past midnight through a 2-hour, 44-minute rain delay, and Atlanta fell to 54-39.", recency: "today" },
    { category: "rotation", title: "Sale unbeaten by the rain: five K's in three scoreless", detail: "Chris Sale had struck out five and allowed nothing over three innings when the tarp came out, and he did not return. The no-decision leaves him 9-6, and the ERA drops to roughly 2.21 with the strikeout lead still in hand heading into his 10th All-Star Game.", recency: "today" },
    { category: "rotation", title: "Tonight: Lopez faces Liberatore in the middle game", detail: "Reynaldo López (4-1, 3.18) makes his ninth start at 7:15 PM ET against Cardinals lefty Matthew Liberatore (4-6, 5.34), who struck out nine against Atlanta at Truist Park on June 30. The Braves need the win to keep the series alive.", recency: "today" },
    { category: "transaction", title: "Waldrep optioned to Gwinnett; Kinley back from paternity list", detail: "Atlanta reinstated reliever Tyler Kinley from the paternity list Friday and optioned right-hander Hurston Waldrep to Triple-A Gwinnett, four days after Ryan O'Hearn hit two of his three home runs off him in Pittsburgh.", recency: "today" },
    { category: "standings", title: "Braves lead the NL East by 3.0 at 54-39", detail: "Everyone in the division lost Friday. Philadelphia dropped 10-2 in Detroit and Miami fell 3-2 to Cleveland, leaving both at 52-43 and 3.0 back. Washington is 7.0 out at 48-47, and the Mets, beaten 6-2 by Boston, sit 14.5 back at 40-54.", recency: "today" },
