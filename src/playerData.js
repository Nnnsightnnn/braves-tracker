...
export const PLAYERS = [
  // ── STARTING LINEUP ─────────────────────────────────────────────────────────
  {
    ...
    stats: { avg: .249, obp: .373, slg: .431, ops: .804, hr: 6, rbi: 18, sb: 14, bb: 21, so: 33, games: 45 },
    statNote: "1-FOR-4, A RUN AND STEAL #14 IN THE SWEEP-BID LOSS — Acuña singled, stole second and scored in Thursday's 7-2 loss to Toronto, one of just four Atlanta hits against the six-man Blue Jays staff. The legs are fully back: 14 stolen bases on the season, and the on-base motor keeps humming (.373 OBP) even as the average has settled to .249 after the late-May power binge (homers in three straight games May 28–30). Still the catalyst at the top of baseball's best lineup.",
    form: 8.9,
    status: "active",
    injuryNote: null,
  ...
  },
  {
    ...
    stats: { avg: .269, obp: .343, slg: .555, ops: .898, hr: 17, rbi: 47, sb: 0, bb: 18, so: 43, games: 48, doubles: 3 },
    statNote: "SAC FLY RBI #47 IN THE FINALE LOSS — Olson drove in Atlanta's first run with a 3rd-inning sacrifice fly (his 3rd SF) in Thursday's 7-2 loss to Toronto, an otherwise quiet 0-for-3 night that ended his three-game hit streak. He still owns the NL HR lead (17) with 47 RBI and a .898 OPS — the relentless middle-of-the-order anchor even on the nights the lineup goes flat (four hits as a team Thursday).",
    form: 9.3,
    status: "active",
    injuryNote: null,
  ...
  },
  {
    ...
    stats: { avg: .255, obp: .312, slg: .398, ops: .710, hr: 5, rbi: 33, sb: 0, bb: 7, so: 23, games: 41, triples: 1, doubles: 7 },
    statNote: "HOMERS IN BACK-TO-BACK GAMES — SOLO SHOT #5 OFF FISHER — Dubón provided most of Atlanta's offense again Thursday, going 2-for-3 with a walk and a solo homer off Braydon Fisher in the 8th — his 5th HR, one night after his go-ahead three-run shot won the series. He also made a diving stop on Ernie Clement in the 1st and started a double play. 33 RBI from a super-utility man, and with Ha-Seong Kim scuffling, Weiss keeps riding the Dubón/Mateo mix at shortstop.",
    form: 9.4,
    status: "active",
    injuryNote: null,
  ...
  },
  {
    ...
    stats: { era: 2.79, whip: 1.07, ip: 51.2, k: 38, bb: 18, w: 3, l: 3, games: 12, starts: 8 },
    statNote: "STARTS TONIGHT — HOMESTAND CONTINUES vs PITTSBURGH (FRI 7:15 PM ET) — Pérez (3-3, 2.79 ERA across 12 G / 8 starts, per the official AP line) opens the Pirates series at Truist Park opposite RHP Mitch Keller (5-2, 4.35). The veteran lefty is coming off the solid series-clinching start at Cincinnati May 30 (5 IP / 4 H / 2 R) and gets a Pittsburgh lineup that just dropped its series in Houston. The $2M offseason signing remains one of the staff's best bargains.",
    form: 8.0,
    status: "active",
    injuryNote: null,
...
export const UPCOMING_SCHEDULE = [
  {
    ...
    home: true,
    venue: "Truist Park",
    atlSP: { id: "perez-martin", name: "Martín Pérez", record: "3-3", era: 2.79, daysRest: 5, hand: "L" },
    oppSP: { name: "Mitch Keller", record: "5-2", era: 4.35, hand: "R" },
    note: "Pirates series opener · Pérez gets the ball coming off his solid series-clinching start at Cincinnati · Keller has quietly been Pittsburgh's steadiest arm at 5-2",
  },
  {
    date: "2026-06-06",
    weekday: "Sat",
    ...
    oppSP: { name: "Braxton Ashcraft", record: null, era: null, hand: "R" },
    note: "Middle game vs Pittsburgh · Strider back out after taking the loss in Cincinnati despite 8 K over 5 IP",
  },
  {
    date: "2026-06-07",
    weekday: "Sun",
...
export const NEXT_GAME = {
  ...
  probables: {
    atl: { pitcher: "Martín Pérez", record: "3-3", era: 2.79 },
    opp: { pitcher: "Mitch Keller", record: "5-2", era: 4.35 },
  },
  note: "TONIGHT 7:15 PM ET — PIRATES SERIES OPENER AT TRUIST — MLB-best Atlanta (42-21, .667) opens a three-game weekend set vs Pittsburgh after Thursday's sweep bid was snuffed out 7-2 by Toronto rookie Chad Dallas's debut win. MARTÍN PÉREZ (3-3, 2.79) draws the opener against MITCH KELLER (5-2, 4.35); Strider goes Saturday (4:10) and Elder Sunday (1:35) opposite top prospect Bubba Chandler. Watch list: new catcher AUSTIN WYNNS (acquired from the Angels, Tromp DFA'd) is active and pairs with Sandy León while Baldwin (oblique, targeting the June 16–21 homestand) and Murphy (finger) mend; the NL East lead is 9.0 over a warming Philadelphia. Atlanta is 17-2-1 in series this season.",
};
...
export const NL_EAST_STANDINGS = [
  { team: "ATL", name: "Atlanta Braves",         w: 42, l: 21, pct: .667, gb: 0,    streak: "L1" },
  { team: "PHI", name: "Philadelphia Phillies",  w: 32, l: 29, pct: .525, gb: 9.0,  streak: "W2" },
  { team: "WSH", name: "Washington Nationals",   w: 31, l: 31, pct: .500, gb: 10.5, streak: "L3" },
  { team: "MIA", name: "Miami Marlins",          w: 28, l: 34, pct: .452, gb: 13.5, streak: "W3" },
  { team: "NYM", name: "New York Mets",          w: 27, l: 34, pct: .443, gb: 14.0, streak: "W2" },
];

// ─── NEWS DIGEST — the recency-biased summary the skill refreshes daily ──────────
export const NEWS_DIGEST = {
  generatedAt: "2026-06-05T04:45:00-04:00",
  summary:
    "SWEEP DENIED, PIRATES IN TOWN TONIGHT — MLB-best Atlanta (42-21, .667, L1) had its sweep bid snuffed out 7-2 Thursday by Toronto rookie CHAD DALLAS, who won his MLB debut as six Blue Jays pitchers combined on a FOUR-HITTER. CHRIS SALE (LP, 8-4) was pecked for a season-high 10 hits in 5.2 IP despite averaging 97 mph on the four-seamer again; REYNALDO LÓPEZ gave up four in the 9th. MAURICIO DUBÓN homered in a second straight game (#5) and MATT OLSON's sac fly (RBI #47) had the only other run. The big roster move: catcher AUSTIN WYNNS acquired from the Angels for cash and activated Thursday, with CHADWICK TROMP DFA'd — Wynns pairs with Sandy León until Baldwin (June 16–21 target) and Murphy return. Tonight MARTÍN PÉREZ (3-3, 2.79) opens the Pittsburgh series at 7:15 PM ET vs MITCH KELLER (5-2, 4.35); Strider goes Saturday, Elder vs top prospect Bubba Chandler Sunday. The NL East lead is 9.0 over surging Philadelphia (32-29, W2), which just swept its season series vs San Diego behind Wheeler's seven strong.",
  keyTopics: [
    { category: "result",      title: "Sweep bid snuffed out — rookie Chad Dallas four-hits the Braves, 7-2",                             detail: "Toronto's Chad Dallas (1-0) won his MLB debut Thursday — 3.2 IP, 2 H, 1 R behind an opener — as six Blue Jays pitchers held Atlanta to four hits. Chris Sale (8-4) allowed three runs on a season-high 10 hits in 5.2 IP, and Reynaldo López was tagged for four in the 9th of the 7-2 loss. Toronto piled up 16 hits; Myles Straw drove in three." },
    { category: "transaction", title: "Braves acquire C Austin Wynns from the Angels; Tromp DFA'd",                                       detail: "Atlanta added the 35-year-old veteran catcher for cash Wednesday and activated him Thursday — he debuted in the 8th inning that night. Chadwick Tromp, the walk-off hero of May 22, was designated for assignment in the corresponding move. Wynns (#16) pairs with Sandy León until Baldwin and Murphy come off the IL." },
    { category: "rotation",    title: "TONIGHT: Pérez vs Keller opens the Pirates series at Truist",                                      detail: "Martín Pérez (3-3, 2.79) draws the 7:15 PM ET opener of the weekend set vs Pittsburgh, opposite Mitch Keller (5-2, 4.35). Strider follows Saturday at 4:10 vs Braxton Ashcraft, and Elder faces top prospect Bubba Chandler in Sunday's 1:35 finale. The Pirates arrive off a series loss in Houston." },
    { category: "standings",   title: "NL East: ATL 42-21, lead trimmed to 9.0 over a warming Philadelphia",                              detail: "Atlanta still owns baseball's best record at 42-21 (.667), but the Phillies (32-29, W2) beat San Diego 6-4 Thursday behind Zack Wheeler's seven strong innings to finish a season-series sweep of the Padres and cut the gap to 9.0. Washington (31-31) is 10.5 back after being swept by Miami (28-34, W3); the Mets (27-34) sit 14.0 out." },
    { category: "narrative",   title: "Sale's velocity is real — 97 mph average again, even in the loss",                                 detail: "Sale's four-seamer averaged 97 mph for a second straight start Thursday, his hardest sustained velocity since 2019, and he struck out six without allowing a homer. The damage was death-by-singles in a three-run 3rd. His season line after the first loss since April: 8-4, 2.23 ERA, NL-leading 86 K." },
    { category: "narrative",   title: "Dubón stays hot — homers in back-to-back games",                                                   detail: "A night after his go-ahead three-run shot clinched the series, Mauricio Dubón went 2-for-3 with a walk and a solo homer off Braydon Fisher (#5), accounting for half of Atlanta's hits Thursday. With Ha-Seong Kim scuffling, Weiss keeps leaning on the Dubón/Mateo shortstop mix — 33 RBI from the super-utility man." },
    ...
    { category: "injury",      title: "Jiménez had a second knee surgery — season in doubt",                                              detail: "Walt Weiss revealed Wednesday that reliever Joe Jiménez underwent another surgery on his left knee 3-to-4 weeks ago — his second procedure. There is no timetable, and a 2026 return looks increasingly unlikely for the veteran setup man." },
    { category: "lineup",      title: "Shortstop is a matchup carousel while Kim scuffles",                                               detail: "With Ha-Seong Kim struggling at the plate, Weiss is mixing Jorge Mateo and Mauricio Dubón at shortstop day-to-day. Dubón started there Thursday (and homered); Mateo pinch-hit. Kim's glove keeps him in the picture, but the bat has to come around for everyday duty." },
    { category: "narrative",   title: "Still baseball's best: 42-21, 17-2-1 in series, 9.0-game cushion",                                 detail: "Even after the finale loss, Atlanta owns MLB's best record and a 17-2-1 series mark, weathering IL stints from Baldwin, Murphy, Schwellenbach, Smith-Shawver, Waldrep and Jiménez. The Iglesias-led bullpen back end (11-for-11 saves, 0.00 ERA) remains untouched — Thursday's 9th-inning mess never reached him." },
  ],
  sources: [
