...
export const UPCOMING_SCHEDULE = [
  {
    ...
    home: true,
    venue: "Truist Park",
    atlSP: { id: "elder", name: "Bryce Elder", record: "4-3", era: 2.50, daysRest: 6, hand: "R" },
    oppSP: { name: "Kevin Gausman", record: "4-3", era: 3.23, hand: "R" },
    note: "Homestand opener vs Toronto at Truist Park · Elder on regular rest looking to bounce back from the 8-0 Fenway blow-up that nudged his ERA to 2.50 · opposite Blue Jays RHP Kevin Gausman (4-3, 3.23)",
  },
  {
    date: "2026-06-03",
    weekday: "Wed",
    ...
    note: "Homestand continues vs Toronto at Truist Park · Sale lines up on regular rest after his 8-K Fenway homecoming win · Blue Jays starter TBD",
  },
  {
    date: "2026-06-04",
    weekday: "Thu",
    ...
    home: true,
    venue: "Truist Park",
    atlSP: { id: "strider", name: "Spencer Strider", record: "3-1", era: 3.19, daysRest: 4, hand: "R" },
    oppSP: { name: "TBD", record: null, era: null, hand: null },
    note: "Series finale vs Toronto (day game) · Strider back out after taking the loss in Cincinnati despite 8 K over 5 IP · Blue Jays starter TBD",
  },
];
...
export const NEXT_GAME = {
  ...
  probables: {
    atl: { pitcher: "Bryce Elder", record: "4-3", era: 2.50 },
    opp: { pitcher: "Kevin Gausman", record: "4-3", era: 3.23 },
  },
  note: "TONIGHT 7:15 PM ET — HOMESTAND OPENER vs TORONTO — After a Monday off-day, MLB-best Atlanta (40-20, .667, L1) is back at Truist Park to open a three-game interleague series with the Blue Jays, having last played a 6-4 loss in Cincinnati on Sunday that cost the road sweep. BRYCE ELDER (4-3, 2.50 ERA) takes the ball looking to rebound from the 8-0 Fenway blow-up, opposite Blue Jays RHP KEVIN GAUSMAN (4-3, 3.23 ERA). Watch list: the catching corps is still thin with Baldwin (oblique, eyeing a mid-June return) and Murphy (finger, hopeful by the All-Star break) on the IL and a León / Tromp tandem behind the plate; the NL East lead sits at 9.0 games over Philadelphia. Sale and Strider line up to follow in the series.",
};
...
export const NL_EAST_STANDINGS = [
  { team: "ATL", name: "Atlanta Braves",         w: 40, l: 20, pct: .667, gb: 0,    streak: "L1" },
  { team: "PHI", name: "Philadelphia Phillies",  w: 30, l: 28, pct: .517, gb: 9.0,  streak: "L1" },
  { team: "WSH", name: "Washington Nationals",   w: 30, l: 30, pct: .500, gb: 10.0, streak: "L1" },
  { team: "MIA", name: "Miami Marlins",          w: 27, l: 33, pct: .450, gb: 13.0, streak: "W1" },
  { team: "NYM", name: "New York Mets",          w: 25, l: 34, pct: .424, gb: 14.5, streak: "L1" },
];

// ─── NEWS DIGEST — the recency-biased summary the skill refreshes daily ──────────
export const NEWS_DIGEST = {
  generatedAt: "2026-06-02T08:45:00-04:00",
  summary:
    "GAME DAY — BRAVES OPEN TORONTO HOMESTAND TONIGHT AFTER A MONDAY BREATHER — MLB-best Atlanta (40-20, .667, L1) returns to Truist Park tonight at 7:15 PM ET to open a three-game interleague series with the Blue Jays, BRYCE ELDER (4-3, 2.50) vs RHP Kevin Gausman (4-3, 3.23), with Sale and Strider lined up to follow. The Braves were off Monday after the Boston/Cincinnati trip; their last action was Sunday's 6-4 loss at Cincinnati that cost the road sweep. The division cushion holds at 9.0 games over Philadelphia (30-28) — Washington fell to 30-30 and Miami climbed to 27-33 after the Marlins beat the Nationals 7-3 Monday, while the Mets dropped to 25-34. Roster move: Atlanta optioned RHP Anthony Molina back to Gwinnett and outrighted Carlos Carrasco to the Stripers. Catching corps still thin — Baldwin (oblique) eyeing mid-June, Murphy (finger) hopeful by the All-Star break; Schwellenbach throwing, Waldrep on Florida-complex bullpens.",
  keyTopics: [
    { category: "rotation",    title: "TONIGHT: Elder opens the homestand vs Toronto's Gausman",                                         detail: "Bryce Elder (4-3, 2.50) draws the 7:15 PM ET homestand opener against Blue Jays RHP Kevin Gausman (4-3, 3.23). Elder looks to bounce back from the 8-0 Fenway blow-up that nudged his ERA to 2.50 — still one of the best marks in the rotation behind a 1.08 WHIP and 61 K. Sale (Wed) and Strider (Thu) line up behind him in the interleague set." },
    { category: "transaction", title: "Roster move: Molina optioned, Carrasco outrighted",                                              detail: "Atlanta optioned RHP Anthony Molina back to Triple-A Gwinnett on Monday and outrighted Carlos Carrasco to the Stripers after Carrasco cleared waivers — the 39-year-old's third trip off the 40-man this year. Both stay in the org as depth while Schwellenbach and Waldrep work back; the active bullpen resets ahead of the Toronto series." },
    { category: "standings",   title: "NL East: ATL 40-20, lead at 9.0 over Philadelphia",                                              detail: "Atlanta holds the best record in baseball and the largest division lead at 40-20 (.667). The cushion is 9.0 over Philadelphia (30-28), with Washington 10.0 back (30-30) after Monday's home loss, Miami 13.0 back (27-33) after snapping a five-game skid, and the Mets 14.5 back (25-34)." },
    { category: "result",      title: "Last out: Reds beat Braves 6-4 Sunday, avoid the sweep",                                          detail: "Atlanta's most recent game was Sunday's 6-4 finale loss at Great American Ball Park, which ended the win streak and denied the road sweep. Eugenio Suárez (first HR since April 15) and JJ Bleday went deep, Nick Lodolo (W, 2-1) allowed three earned over 6.2 innings, and the Braves stranded the tying run in the ninth." },
    { category: "milestone",   title: "Acuña's 39th career leadoff HR — 5 homers in 4 games",                                          detail: "Ronald Acuña Jr. ambushed Lodolo's first pitch Sunday for his franchise-record 39th career leadoff home run, his fifth homer in a four-game span after the Fenway grand slam and back-to-back Cincinnati shots. The power surge buries any lingering concern about the left thumb bone bruise he managed earlier in May." },
    { category: "injury",      title: "Baldwin eyeing mid-June, Murphy hopeful by All-Star break",                                       detail: "Alex Anthopoulos pegged Drake Baldwin (right oblique strain, 10-day IL) for a roughly mid-June return — possibly sooner, with little rehab needed. Sean Murphy (fractured left middle finger) is a longer wait: Atlanta is hopeful by the All-Star break, though it could stretch to the deadline. Sandy León / Chadwick Tromp keep splitting duties. Baldwin's frozen line: .312/.380/.569, 12 HR / 35 RBI." },
    ...
    { category: "rotation",    title: "Strider looks the part again — 8 K in Sunday's loss",                                             detail: "Spencer Strider (LP, 3-1) was solid in defeat Sunday — 5 IP / 7 H / 3 R / 2 BB / 8 K. His season line sits at 3-1 / ~3.19 ERA / 1.21 WHIP / 41 K across 6 starts; the IL-returnee still looks like a frontline arm and lines up for the Toronto finale Thursday." },
    { category: "narrative",   title: "Olson stays atop the NL home-run race — #16",                                                     detail: "Matt Olson sits as the NL home-run and FanGraphs WAR leader at 16 HR, his line around .298/.371/.633 (1.004 OPS) with 42 RBI — the steady middle-of-the-order force all season as Atlanta navigates injuries around him." },
    { category: "narrative",   title: "Iglesias still spotless — 10-for-10 in saves, 0.00 ERA",                                          detail: "Raisel Iglesias remains perfect on the season: 10 saves in 10 chances and a 0.00 ERA (0.47 WHIP, 15 K / 1 BB across 12.2 IP). The Dylan Lee → Iglesias bridge is the deepest, most reliable back end in the NL." },
    { category: "rotation",    title: "Sale anchors the staff — NL-leading strikeouts, 10-1 in his starts",                              detail: "Chris Sale (8-3) remains the rotation's anchor after his 8-K win in his charged Fenway return, where he won the 2018 World Series. His 2.02 ERA, 0.87 WHIP and NL-leading strikeout total have Atlanta at 10-1 in his starts since the 2024 trade; he lines up to start Wednesday vs Toronto." },
  ],
  sources: [
