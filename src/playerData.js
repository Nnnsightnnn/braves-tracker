...
export const PLAYERS = [
  ...
  // ── BULLPEN ─────────────────────────────────────────────────────────────────
  {
    ...
    stats: { era: 1.15, whip: 0.93, ip: 18.1, k: 21, bb: 1, sv: 13, hold: null, games: 17, w: 0, l: 2 },
    statNote: "(L, 0-2) WALKED OFF IN THE 10TH: Iglesias took the loss Tuesday at Petco, surrendering a one-out RBI single to Manny Machado in the 10th that scored Jackson Merrill for a 7-6 San Diego walk-off, the Padres' sixth of the year. Entered a tie game in extras and could not strand the runner. The underlying ledger stays elite (1.15 ERA, 0.93 WHIP, 21 K / 1 BB, 13-for-14 in saves), and the resume says he bounces back fast.",
    form: 7.0,
    status: "active",
    injuryNote: null,
...
export const NEXT_GAME = {
  ...
  probables: {
    atl: { pitcher: "Martín Pérez", record: "6-3", era: 2.78 },
    opp: { pitcher: "TBD", record: null, era: null },
  },
  note: "GOING FOR THE SALVAGE GAME AT PETCO. After a brutal 7-6 walk-off loss Tuesday night, Atlanta tries to avoid a sweep Wednesday at 8:40 PM ET in the San Diego finale. Lefty MARTIN PEREZ (6-3, 2.78) gets the ball on his strongest run of the season, four straight winning starts, against a Padres starter still listed as TBD. The Braves have dropped nine of their last 12 and both games in this series, slipping to 48-30, but they remain comfortably atop the NL East by about six games over Philadelphia. RONALD ACUNA JR. (hamstring) is still weeks away with a July timeline; SPENCER STRIDER (60-day IL, elbow) is shut down into mid-August; SEAN MURPHY (60-day, finger) is in a splint targeting mid-July. JOEY BART backs up Drake Baldwin behind the plate.",
};
...
export const NL_EAST_STANDINGS = [
  { team: "ATL", name: "Atlanta Braves",         w: 48, l: 30, pct: .615, gb: 0,    streak: "L3" },
  { team: "PHI", name: "Philadelphia Phillies",  w: 42, l: 36, pct: .538, gb: 6.0,  streak: "W1" },
  { team: "WSH", name: "Washington Nationals",   w: 40, l: 37, pct: .519, gb: 7.5,  streak: "W1" },
  { team: "MIA", name: "Miami Marlins",          w: 39, l: 38, pct: .506, gb: 8.5,  streak: "W3" },
  { team: "NYM", name: "New York Mets",          w: 34, l: 42, pct: .447, gb: 13.0, streak: "L1" },
];

// ─── NEWS DIGEST — the recency-biased summary the skill refreshes daily ──────────
export const NEWS_DIGEST = {
  generatedAt: "2026-06-24T04:45:00-04:00",
  summary:
    "WALKED OFF IN SAN DIEGO. The Padres beat Atlanta 7-6 in 10 innings Tuesday night at Petco Park, Manny Machado lining a one-out RBI single off Raisel Iglesias to score Jackson Merrill and hand San Diego its sixth walk-off win of the year. The Braves clawed out of a 5-0 second-inning hole, tying it on Ozzie Albies' RBI double in the 4th and grabbing a 6-5 lead on Mauricio Dubón's solo homer in the 5th, but Fernando Tatis Jr. answered with a game-tying homer in the 7th and Mason Miller (2 IP, 3 K) shut the door before Machado finished it. Atlanta has now lost nine of its last 12 and dropped the first two in San Diego, slipping to 48-30, though it still leads the NL East by about six games over Philadelphia. Martín Pérez (6-3, 2.78) takes the ball Wednesday at 8:40 PM ET in the finale on his strongest run of the year. On the health front, Ronald Acuña Jr. (hamstring) remains weeks away with a July target, Spencer Strider (elbow) is shut down into roughly mid-August, Sean Murphy (finger) is in a splint aiming for mid-July, and Spencer Schwellenbach and AJ Smith-Shawver are both progressing in their throwing programs.",
  keyTopics: [
    { category: "result",      title: "Machado walks off the Braves 7-6 in 10",                                                     detail: "San Diego stunned Atlanta on Tuesday night, Manny Machado lining a one-out RBI single off Raisel Iglesias in the 10th to score Jackson Merrill for the Padres' sixth walk-off win of the year. The Braves dropped the first two in San Diego and fell to 48-30." },
    { category: "narrative",   title: "Atlanta blows a late lead, loses 9 of 12",                                                    detail: "The Braves dug out of a 5-0 second-inning hole and led 6-5 in the 5th, but could not hold it. Atlanta has now lost nine of its last 12 with the offense and bullpen both wobbling on the West Coast trip." },
    { category: "lineup",      title: "Dubón homer, Albies double fuel the comeback",                                               detail: "Mauricio Dubón put Atlanta ahead 6-5 with a solo homer in the 5th, his 7th of the year, after Ozzie Albies tied it with an RBI double in the 4th. The pair gave the Braves a brief lead before the bullpen faltered." },
    { category: "rotation",    title: "Tatis ties it, Miller slams the door",                                                       detail: "Fernando Tatis Jr. homered in the 7th to erase Atlanta's lead, then Mason Miller (W, 2-1) worked two scoreless innings with three strikeouts to set up the walk-off. Tatis had also driven in a run during the Padres' five-run 2nd." },
    { category: "rotation",    title: "Pérez starts the finale Wednesday",                                                          detail: "Lefty Martín Pérez (6-3, 2.78) gets the ball Wednesday at 8:40 PM ET as Atlanta tries to salvage the San Diego finale and avoid a sweep. Pérez has won four straight starts, his steadiest stretch of the season." },
    { category: "injury",      title: "Acuña still weeks away, July target",                                                       detail: "Ronald Acuña Jr. remains a long way from returning from his Grade 1 left-hamstring strain, with Atlanta extra cautious because it is the second issue to that same spot. The realistic target stays in July." },
    { category: "injury",      title: "Strider shut down into mid-August",                                                          detail: "Spencer Strider remains on the 60-day injured list with right elbow inflammation and no ligament damage. After being shut down for about four weeks, his earliest realistic return is roughly mid-August." },
    { category: "injury",      title: "Murphy in a splint, targeting mid-July",                                                     detail: "Sean Murphy had the cast removed and is now in a splint to protect his fractured left middle finger. He stays on the 60-day IL with a return targeted around mid-July while Drake Baldwin and Joey Bart catch." },
    { category: "injury",      title: "Schwellenbach, Smith-Shawver progressing",                                                   detail: "Spencer Schwellenbach is throwing and building up, with a speculative August or September return, while AJ Smith-Shawver is throwing high-intensity bullpens and is close to facing live hitters. Neither has a firm date yet." },
    { category: "lineup",      title: "Olson keeps the NL home run lead",                                                          detail: "Matt Olson leads the majors and the NL with 20 homers and 52 RBI while keeping his OPS near .900. With Acuña out, he and Ozzie Albies remain the spine of the order." },
    ...
    { category: "standings",   title: "NL East: ATL 48-30, lead about 6 over Philadelphia",                                        detail: "Atlanta still leads the NL East by roughly six games over second-place Philadelphia, but it no longer owns baseball's best record after the Dodgers moved ahead. Washington, Miami, and the last-place Mets fill out the division." },
  ],
  sources: [
