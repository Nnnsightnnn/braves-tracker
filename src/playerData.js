...
export const PLAYERS = [
  // ── STARTING LINEUP ─────────────────────────────────────────────────────────
  {
    ...
    statNote: "RETURN DELAYED, NOT IN FRIDAY'S OPENER: Acuña was held out of the series opener at Baltimore, with Jorge Mateo drawing a rare start in right, so his activation stays day-to-day. Gwinnett was rained out Friday and his next rehab at-bats moved to a Saturday doubleheader. Weiss has said the outfielder is physically good to go and the wait is about being impactful at the plate; nine of his last 14 balls in play at Gwinnett left the bat at 95-plus mph. The big-league line stays frozen at .251/.373/.421 with 6 HR and 15 SB through 48 games.",
    form: 8.2,
    status: "il-10",
    injuryNote: "GRADE 1 LEFT HAMSTRING STRAIN (recurrence in the same left hamstring as May's strain), on the 10-day IL since June. REHAB AT TRIPLE-A GWINNETT, where he has taken outfield innings and shown no lingering effects (scored from second on a headfirst slide, stole a base). ACTIVATION PUSHED BACK: he was not activated for Friday's opener in Baltimore, and with Gwinnett rained out his next rehab at-bats are set for a Saturday doubleheader. Weiss expects him back during the weekend series, used primarily in right field.",
