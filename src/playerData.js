...
export const PLAYERS = [
  ...
  },
  {
    ...
    stats: { era: 3.38, whip: 1.18, ip: 85.1, k: 61, bb: 27, w: 6, l: 6, games: 19, starts: 15 },
    statNote: "ACTIVATED AND FOUR SCORELESS IN HIS RETURN: Perez was reinstated from the 15-day IL on Wednesday and gave Atlanta exactly what the rotation needed, four scoreless innings with three strikeouts against San Diego before the bullpen and a six-run 8th carried a 7-6 win. JR Ritchie was optioned to Gwinnett in the corresponding move. It was his first outing since the July 5 forearm contusion, and if he holds this form the rotation stabilizes without a deadline trade.",
    form: 6.5,
    status: "active",
    injuryNote: null,
  ...
  // ── BULLPEN ─────────────────────────────────────────────────────────────────
  {
    ...
    stats: { era: 1.88, whip: 0.88, ip: 24.0, k: 28, bb: 1, sv: 20, hold: null, games: 23, w: 0, l: 2 },
    statNote: "SWEATED OUT SAVE NO. 20: Iglesias entered Wednesday's 7-6 win with a 7-1 lead already shrinking and gave up a two-run homer to Luis Rengifo before striking out Manny Machado and Ty France to end it. It was his first run allowed in weeks but he stayed a perfect 20-for-20 in save chances, still the longest active conversion streak in the majors dating to 2025. With Robert Suarez out, he and Dylan Lee remain the whole back end.",
    form: 8.2,
    status: "active",
    injuryNote: null,
...
export const NEXT_GAME = {
  ...
  probables: {
    ...
    opp: { pitcher: "Griffin Canning", record: "1-8", era: 6.67 },
  },
  note: "SALE CLOSES THE HOMESTAND WITH A SERIES WIN ON THE LINE. Atlanta took the series lead the hard way Wednesday, surviving 7-6 after a six-run 8th and a five-run Padres 9th, so the getaway-day finale can bag three of four. CHRIS SALE (10-6, 2.06) takes the ball at 12:15 PM ET on five days' rest, carrying the loudest NL Cy Young case in the league off seven scoreless on Friday and his 2,700th career strikeout, against GRIFFIN CANNING (1-8, 6.67). MARTIN PEREZ returned from the IL to give Atlanta four scoreless Wednesday, and JR RITCHIE was optioned to Triple-A Gwinnett in the corresponding move. IL watch: ACUNA (hamstring) is still not activated and picked up two hits in a Thursday rehab game at Triple-A Gwinnett, with a return to right field expected soon; KIM (finger) is rehabbing alongside him; HURSTON WALDREP is being evaluated after leaving his Gwinnett start with right arm discomfort; AJ SMITH-SHAWVER threw 4 1/3 scoreless at Gwinnett on Saturday; STRIDER (60-day, elbow) is a long shot for any 2026 innings; SCHWELLENBACH (60-day) still has not started his four-to-six-week ramp; SEAN MURPHY (60-day, finger), ROBERT SUAREZ (forearm), and MIKE YASTRZEMSKI (elbow) all remain out.",
};
...
export const NL_EAST_STANDINGS = [
  { team: "ATL", name: "Atlanta Braves",         w: 59, l: 42, pct: .584, gb: 0,    streak: "W1" },
  { team: "PHI", name: "Philadelphia Phillies",  w: 56, l: 47, pct: .544, gb: 4.0,  streak: "L2" },
  { team: "MIA", name: "Miami Marlins",          w: 52, l: 50, pct: .510, gb: 7.5,  streak: "L4" },
  { team: "WSH", name: "Washington Nationals",   w: 52, l: 51, pct: .505, gb: 8.0,  streak: "W1" },
  { team: "NYM", name: "New York Mets",          w: 43, l: 60, pct: .417, gb: 17.0, streak: "L1" },
];
...
export const NEWS_DIGEST = {
  generatedAt: "2026-07-23T09:00:00-04:00",
  summary:
    "A SIX-RUN EIGHTH, A NINTH-INNING SCARE, AND THE SERIES LEAD. Atlanta beat San Diego 7-6 on Wednesday night at Truist Park, taking a one-run game and nearly giving it all back. Martin Perez, activated from the IL that afternoon, gave the club four scoreless with three strikeouts in a 1-1 game before the bats erupted for six in the 8th: Mauricio Dubon and Jim Jarvis started it with back-to-back hits off Wandy Peralta, Jarvis's double scoring Dubon from first, and Brewer Hicklen, Ozzie Albies, Matt Olson, Austin Riley, and Dominic Smith all drove in runs. Up 7-1, the bullpen made it interesting: Victor Mederos gave up a Gavin Sheets single and a Fernando Tatis Jr. two-run triple in the 9th, and Raisel Iglesias allowed a Luis Rengifo homer before striking out Manny Machado and Ty France for his 20th save. JR Ritchie was optioned to Gwinnett in the corresponding move for Perez. The Braves are 59-42 and now four up on Philadelphia, which lost 9-5 to the Dodgers. Chris Sale (10-6, 2.06) can close the homestand with three of four Thursday at 12:15 PM ET against Griffin Canning (1-8, 6.67). Ronald Acuna Jr. is still not activated and picked up two hits in a Thursday rehab game at Gwinnett, with an outfield return expected soon.",
  keyTopics: [
    { category: "result", title: "Braves 7, Padres 6: a six-run 8th takes the series lead", detail: "Atlanta broke a 1-1 game open with six runs in the 8th, all with two on and none of the damage on the long ball. Mauricio Dubon and Jim Jarvis opened it against Wandy Peralta, and Hicklen, Albies, Olson, Riley, and Dominic Smith followed with RBI hits. The Braves collected seven of their 14 hits in the inning and moved to 59-42.", recency: "today" },
    { category: "rotation", title: "Perez returns with four scoreless in his first outing since July 5", detail: "Activated from the 15-day IL earlier in the day, Perez gave Atlanta four scoreless innings and three strikeouts in a game the rotation needed, having taken the forearm contusion off a Juan Soto line drive on July 5. If he holds this, the rotation stabilizes without a deadline trade. JR Ritchie was optioned to Gwinnett in the corresponding move.", recency: "today" },
    { category: "result", title: "Iglesias sweats out save No. 20 after a five-run Padres 9th", detail: "Up 7-1, Victor Mederos surrendered an RBI single to Gavin Sheets and a two-run triple to Fernando Tatis Jr., and Iglesias gave up a two-run homer to Luis Rengifo before striking out Manny Machado and Ty France to end it. It was his first run allowed in weeks, but he stayed a perfect 20-for-20 in save chances.", recency: "today" },
    { category: "rotation", title: "Sale closes the homestand Thursday against Canning", detail: "Chris Sale (10-6, 2.06) takes the ball at 12:15 PM ET on five days' rest, carrying the loudest NL Cy Young case in the league, against Griffin Canning (1-8, 6.67). A win banks three of four in the four-game set before Atlanta hits the road.", recency: "today" },
    { category: "injury", title: "Acuna still not activated, two hits in a Thursday rehab game", detail: "Acuna remains on the 10-day IL and collected a pair of singles in a rehab outing for Triple-A Gwinnett on Thursday. The plan is for him to see most of his time in right field once activated, and he will get a few more Gwinnett games first to sharpen up. Atlanta's June slide began the day he went back on the IL.", recency: "today" },
    { category: "standings", title: "Atlanta 59-42, four up on Philadelphia", detail: "The Phillies lost 9-5 to the Dodgers on Wednesday to fall to 56-47, so the Braves' win pushed the division lead to four. Washington routed Colorado 8-0 to reach 52-51, Miami lost 5-2 in Houston to drop to 52-50, and the Mets fell 4-3 at Milwaukee to slip to 43-60. The deadline is Aug. 3.", recency: "today" },
    { category: "injury", title: "Waldrep is being evaluated after leaving his Gwinnett start", detail: "Waldrep left his Sunday start at Triple-A Gwinnett with right arm discomfort and is being evaluated with no timeline. He was the nearest internal answer to the rotation problem. He had elbow surgery in February to remove loose bodies and did not pitch until June 12, which makes any new arm complaint worth watching.", recency: "this-week" },
    { category: "rotation", title: "Smith-Shawver threw 4 1/3 scoreless at Gwinnett on Saturday", detail: "Five strikeouts, and his sharpest step yet coming back from June 2025 Tommy John surgery. Weiss said he could be available in Atlanta soon if the rotation needs him. With Strider a long shot for any 2026 innings, Schwellenbach not yet ramping, and Waldrep now being evaluated, that is a live option rather than a formality.", recency: "this-week" },
    { category: "narrative", title: "Anthopoulos frames a broad deadline, with pitching first", detail: "Alex Anthopoulos said the club can add rotation, bullpen, and a bat before the Aug. 3 deadline, and pointed at pitching in particular while leaving the door open on offense. He is weighing internal returns (Acuna for the lineup, Smith-Shawver and Perez for the rotation) against the market, which ties Atlanta to a wide swath of targets over the next two weeks.", recency: "this-week" },
    { category: "milestone", title: "Sale sits 71 strikeouts from Frank Tanana", detail: "The fourth of his six strikeouts in Friday's 15-1 win was No. 2,700 of his career, in an outing where no Texas runner reached third base. He is 10-6 with a 2.06 ERA over 18 starts and takes the ball again Thursday against San Diego.", recency: "this-week" },
    { category: "transaction", title: "Owen Murphy optioned earlier in the week, Hernandez selected", detail: "Atlanta sent the 22-year-old back to Triple-A Gwinnett on July 19 after his first big-league start lasted 2 2/3 innings, and selected veteran right-hander Elieser Hernandez in the corresponding move. Murphy had never pitched above High-A before this season. The move read as deadline-adjacent roster housekeeping.", recency: "this-week" },
