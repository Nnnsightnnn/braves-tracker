// ─── Atlanta Braves Player Data (2026 Season · Updated August 21, 2026) ────────
// Single source of truth for roster, games, standings, digest, and RSS feeds.
// THU AUG 20, HOLMES AND THE BULLPEN SHUT OUT CHICAGO: The Braves salvaged a weird road trip with a
// 2-0 win at the Chicago White Sox on Thursday, a June 11 rainout makeup at Rate Field that ended a
// three-game slide. GRANT HOLMES carried a no-hitter into the seventh before ANDREW BENINTENDI lined
// a leadoff single, finishing six scoreless on 94 pitches with three walks and three strikeouts.
// AUSTIN RILEY doubled and singled to drive in both runs, MAURICIO DUBON had three hits and scored,
// DYLAN LEE spun a perfect eighth, and RAISEL IGLESIAS closed a 1-2-3 ninth for his 26th save to
// complete a one-hitter. Atlanta improved to 75-53 and stayed comfortably atop the NL East. Next up:
// a weekend at NL-best Milwaukee, CHRIS SALE (12-8, 2.17) opening Friday at 4:10 PM ET against
// Brewers left-hander SHANE DROHAN (6-4, 3.87). IL watch, unchanged: REYNALDO LOPEZ (left knee, MRI
// clean) is throwing bullpens toward a late-season return; ROBERT SUAREZ (forearm) resumed throwing
// from 60 feet Aug 13; STRIDER (elbow), SCHWELLENBACH (elbow), JIMENEZ (knee), and WENTZ (torn ACL)
// remain on the 60-day IL. No new roster moves.
//
...
export const NEXT_GAME = {
  ...
  probables: {
    atl: { pitcher: "Chris Sale", record: "12-8", era: 2.17 },
    opp: { pitcher: "Shane Drohan", record: "6-4", era: 3.87 },
  },
  note: "ACE VS THE NL'S BEST TO OPEN THE WEEKEND. Fresh off Thursday's 2-0 shutout of the White Sox that ended a three-game slide, the Braves (75-53) open a weekend set at NL-best Milwaukee on Friday, 4:10 PM ET at American Family Field, with CHRIS SALE (12-8, 2.17) on the mound against Brewers left-hander SHANE DROHAN (6-4, 3.87). Sale keeps building one of the loudest NL Cy Young cases in the game at 160 strikeouts and a sub-2.20 ERA despite repeatedly thin run support. Atlanta stays comfortably atop the NL East, and MATT OLSON sits near the top of the majors in home runs at 36. On the mend: REYNALDO LOPEZ (left knee, MRI clean) is throwing bullpens toward a late-season return, and ROBERT SUAREZ (forearm) has resumed throwing from 60 feet; the 60-day group of STRIDER, SCHWELLENBACH, JIMENEZ, and WENTZ remains out.",
};
...
export const NL_EAST_STANDINGS = [
  { team: "ATL", name: "Atlanta Braves",         w: 75, l: 53, pct: .586, gb: 0,    streak: "W1" },
  { team: "PHI", name: "Philadelphia Phillies",  w: 70, l: 58, pct: .547, gb: 5.0,  streak: "W1" },
  { team: "MIA", name: "Miami Marlins",          w: 64, l: 64, pct: .500, gb: 11.0, streak: "L1" },
  { team: "WSH", name: "Washington Nationals",   w: 61, l: 67, pct: .477, gb: 14.0, streak: "W1" },
  { team: "NYM", name: "New York Mets",          w: 58, l: 70, pct: .453, gb: 17.0, streak: "L1" },
];
...
export const NEWS_DIGEST = {
  generatedAt: "2026-08-21T07:30:00-04:00",
  summary:
    "HOLMES AND THE BULLPEN SHUT OUT CHICAGO, THE SLIDE ENDS. The Braves (75-53) salvaged a strange road trip Thursday with a 2-0 win at the Chicago White Sox, a June 11 rainout makeup at Rate Field that snapped a three-game slide. Grant Holmes carried a no-hitter into the seventh before Andrew Benintendi lined a leadoff single, finishing six scoreless innings on 94 pitches with three walks and three strikeouts. Austin Riley doubled and singled to drive in both runs, Mauricio Dubon had three hits and scored, Dylan Lee spun a perfect eighth, and Raisel Iglesias closed a 1-2-3 ninth for his 26th save to complete a one-hitter. Atlanta stays comfortably atop the NL East, its lead over Philadelphia (70-58) back to 5.0 games with roughly six weeks to play. Chris Sale (12-8, 2.17) opens a weekend set at NL-best Milwaukee on Friday at 4:10 PM ET against Brewers left-hander Shane Drohan (6-4, 3.87). Matt Olson stays near the top of the majors in homers at 36. On the injury front, Reynaldo López (left knee, MRI clean) is throwing bullpens toward a late-season return and Robert Suarez (forearm) has resumed throwing from 60 feet; Strider, Schwellenbach, Jiménez, and Wentz remain on the 60-day IL.",
  keyTopics: [
    { category: "result", title: "Braves 2, White Sox 0: Holmes takes a no-hitter into the seventh", detail: "Grant Holmes carried a no-hit bid into the seventh Thursday at Rate Field before Andrew Benintendi lined a leadoff single, finishing six scoreless on 94 pitches. Dylan Lee and Raisel Iglesias completed the one-hitter as Atlanta snapped a three-game slide.", recency: "today" },
    { category: "result", title: "Riley drives in both runs, Dubon collects three hits", detail: "Austin Riley doubled and singled home all of Atlanta's offense in the 2-0 win, and Mauricio Dubon set the table with a three-hit night and a run scored. It was the kind of bottom-of-the-order production the club lacked on the Minnesota trip.", recency: "today" },
    { category: "standings", title: "NL East lead back to 5.0 over Philadelphia", detail: "Atlanta improved to 75-53 and, with the Phillies at 70-58, sits 5.0 games up in the division. Miami (64-64) is 11.0 back, the Nationals 14.0 out, and the Mets 17.0 behind with roughly six weeks to play.", recency: "today" },
    { category: "rotation", title: "Iglesias closes his 26th, ERA down to 2.03", detail: "Raisel Iglesias worked a clean ninth for his 26th save and trimmed his ERA to 2.03 with a 0.84 WHIP and just two walks all season. With Robert Suarez still on the IL, the Lee-to-Iglesias bridge keeps anchoring the late innings.", recency: "today" },
    { category: "rotation", title: "Sale opens at NL-best Milwaukee on Friday", detail: "Chris Sale (12-8, 2.17) is set to start Friday at 4:10 PM ET at American Family Field against Brewers left-hander Shane Drohan (6-4, 3.87). Sale's NL Cy Young case stays one of the loudest in the league at 160 strikeouts and a sub-2.20 ERA despite repeatedly thin run support.", recency: "today" },
    { category: "milestone", title: "Olson stays near the MLB home run lead at 36", detail: "Matt Olson sits on 36 homers, among the majors' leaders, after carrying the Atlanta offense through August. His bat remains the steadiest source of power in the lineup as the club settles back in after a cold Minnesota trip.", recency: "this-week" },
    { category: "narrative", title: "A weird road trip ends on a high note", detail: "Atlanta lost three straight in Minneapolis and produced just nine runs across the Twins sweep before the pitching-and-defense win in Chicago flipped the mood. The slide is snapped heading into the toughest test of the trip at Milwaukee.", recency: "today" },
    ...
    { category: "standings", title: "Braves hold a commanding division cushion", detail: "Even after the Minnesota sweep, Atlanta enters the weekend with a mid-single-digit lead in the NL East and the best record in the division. The Phillies have kept pace but have not closed the gap enough to make it a true race yet.", recency: "this-week" },
