...
export const PLAYERS = [
  ...
  },
  {
    ...
    statNote: "TAKES THE BALL TUESDAY AGAINST BUEHLER: López (4-2, 3.50) makes his 10th start of the season in the second game of the San Diego set, opposite Walker Buehler (5-5, 5.36), who has been hit hard lately and went just two innings in his last outing. López last pitched July 11 in St. Louis, five innings and four earned, most of it on a Lars Nootbaar three-run homer in the 1st. He carries a .228 batting average against across 22 games and remains the mid-rotation stabilizer behind Sale.",
    form: 6.8,
    status: "active",
    injuryNote: null,
...
export const NEXT_GAME = {
  ...
  probables: {
    atl: { pitcher: "Reynaldo López", record: "4-2", era: 3.50 },
    opp: { pitcher: "Walker Buehler", record: "5-5", era: 5.36 },
  },
  note: "THE ROTATION FINALLY HELD UP ITS END. BRYCE ELDER went six innings on five hits Monday night, both runs on solo homers, and Atlanta beat San Diego 3-2 to open the four-game set. It was the length a bullpen that used 13 pitchers over the weekend badly needed. MICHAEL HARRIS II broke JP Sears's shutout with his 18th home run in the 5th, JOEY BART doubled MAURICIO DUBON home for the lead, and OZZIE ALBIES added his 15th in the 6th, ending a 36-inning homerless streak for Padres lefty Wandy Peralta. VICTOR MEDEROS, up from Gwinnett, threw the final 2 1/3 for the first save of his career. Atlanta is 58-41 and three up in the NL East. Tonight it is REYNALDO LOPEZ (4-2, 3.50) against WALKER BUEHLER (5-5, 5.36) at 7:15 PM ET, Lopez's 10th start and his first since July 11. IL watch: ACUNA (hamstring) is expected back in the lineup this week, possibly before the homestand ends Thursday; KIM (finger) is rehabbing alongside him at Triple-A Gwinnett; MARTIN PEREZ (forearm) is eligible today and lined up for Wednesday; HURSTON WALDREP left his Gwinnett start Sunday with right arm discomfort and is being evaluated this week; AJ SMITH-SHAWVER threw 4 1/3 scoreless at Gwinnett on Saturday; STRIDER (60-day, elbow) is a long shot for any 2026 innings; SCHWELLENBACH (60-day) still has not started his four-to-six-week ramp; SEAN MURPHY (60-day, finger), ROBERT SUAREZ (elbow), and MIKE YASTRZEMSKI (elbow) all remain out.",
};
...
export const NL_EAST_STANDINGS = [
  { team: "ATL", name: "Atlanta Braves",         w: 58, l: 41, pct: .586, gb: 0,    streak: "W2" },
  { team: "PHI", name: "Philadelphia Phillies",  w: 56, l: 45, pct: .554, gb: 3.0,  streak: "W1" },
  { team: "MIA", name: "Miami Marlins",          w: 52, l: 48, pct: .520, gb: 6.5,  streak: "L2" },
  { team: "WSH", name: "Washington Nationals",   w: 51, l: 50, pct: .505, gb: 8.0,  streak: "W2" },
  { team: "NYM", name: "New York Mets",          w: 42, l: 59, pct: .416, gb: 17.0, streak: "L1" },
];
...
export const NEWS_DIGEST = {
  generatedAt: "2026-07-21T09:05:00-04:00",
  summary:
    "A STARTER WENT SIX, AND THAT WAS THE STORY. Atlanta beat San Diego 3-2 on Monday night at Truist Park to open a four-game set, and the number that matters is not the score: it is Bryce Elder's six innings on five hits, both runs on solo homers, after a weekend in which the Braves burned 13 pitchers. Michael Harris II broke JP Sears's shutout with his 18th home run in the 5th, Joey Bart doubled Mauricio Dubon home for the lead, and Ozzie Albies added his 15th in the 6th, ending a 36-inning homerless streak for Padres lefty Wandy Peralta. Victor Mederos, up from Gwinnett, threw the final 2 1/3 innings for the first save of his career. Manny Machado's 4th-inning homer was his 20th, a mark he has reached in all seven of his seasons in San Diego, and Ty France added one off Danny Young in the 7th. It was only Atlanta's second win over the Padres since the start of the 2025 season. The Braves are 58-41 and three up on Philadelphia, which beat the Dodgers 10-7. The rotation news was not all good: Hurston Waldrep, the nearest internal reinforcement and eligible to return this weekend, left his Sunday start at Gwinnett with right arm discomfort and is being evaluated this week. Ronald Acuna Jr. is still expected back in the lineup during this homestand, and Martin Perez becomes IL-eligible today with a Wednesday start lined up. Reynaldo Lopez (4-2, 3.50) faces Walker Buehler (5-5, 5.36) at 7:15 PM ET.",
  keyTopics: [
    { category: "result", title: "Braves 3, Padres 2: Elder goes six, Mederos closes it", detail: "Atlanta opened the four-game set Monday night with the sort of pitching night it had not managed in six weeks. Bryce Elder (6-6) allowed two runs on five hits over six innings, both on solo homers, and Victor Mederos worked the final 2 1/3 for his first career save. It was only the Braves' second win over San Diego since the start of the 2025 season.", recency: "today" },
    { category: "milestone", title: "Mederos records the first save of his career, and it took 2 1/3 innings", detail: "Weiss went to the 24-year-old in the 7th with a one-run lead and never came back for him. Mederos had spent most of the season as Triple-A depth after a two-inning MLB debut in May, and with the bullpen coming off a weekend that required 13 pitchers, the length was as valuable as the result. It is the clearest argument yet for keeping him in Atlanta.", recency: "today" },
    { category: "injury", title: "Waldrep exits his Gwinnett start with right arm discomfort", detail: "Weiss said before Monday's game that Waldrep will be evaluated further this week and offered no timeline. He was eligible to return to Atlanta this weekend, 15 days after the July 10 option, and was the nearest internal answer to the rotation problem. He had elbow surgery in February to remove loose bodies and did not pitch until June 12, which makes any new arm complaint worth watching.", recency: "today" },
    { category: "result", title: "Harris and Albies supply the offense", detail: "Harris II ended Sears's shutout bid with his 18th home run in the 5th, tying the game at 1, and Joey Bart followed with an RBI double scoring Mauricio Dubon. Albies hit his 15th in the 6th off Wandy Peralta, the first home run Peralta had allowed in 36 innings. Harris is hitting .267 with two homers over his last 10 games; Atlanta has 16 home runs in that span.", recency: "today" },
    { category: "rotation", title: "Lopez faces Buehler tonight in the second game", detail: "Reynaldo Lopez (4-2, 3.50) makes his 10th start of the season at 7:15 PM ET, his first outing since July 11 in St. Louis. Walker Buehler (5-5, 5.36) goes for San Diego and lasted only two innings in his last time out, giving up four earned to Toronto. Buehler has been the softest matchup available in this series on paper.", recency: "today" },
    { category: "injury", title: "Acuna is still expected back during this homestand", detail: "Weiss has said activation could come before the four-game set ends Thursday. Acuna has been the designated hitter throughout the rehab, which moved up to Triple-A Gwinnett on July 17, so outfield innings were the last box to clear; Weiss said he will play primarily right field. Atlanta's 29-game slide began June 9, the day he went back on the IL.", recency: "today" },
    { category: "standings", title: "Atlanta 58-41, three up on Philadelphia", detail: "The Phillies beat the Dodgers 10-7 on Monday to reach 56-45, so the lead held at three. Miami lost 8-4 in Houston and dropped to 52-48, 6.5 back. Washington beat Colorado 6-3 to get to 51-50, and the Mets lost 8-3 in Milwaukee to fall to 42-59, seventeen out. The deadline is Aug. 3.", recency: "today" },
    { category: "transaction", title: "Owen Murphy optioned, Elieser Hernandez selected", detail: "Atlanta sent the 22-year-old back to Triple-A Gwinnett on July 19 after his first big-league start lasted 2 2/3 innings, and selected the contract of veteran right-hander Elieser Hernandez in the corresponding move. Murphy had never pitched above High-A before this season and carried a 4.44 ERA over 16 minor-league starts. The move was read as deadline-adjacent roster housekeeping.", recency: "yesterday" },
    { category: "injury", title: "Perez is IL-eligible today and lined up for Wednesday", detail: "He has been on the 15-day IL since July 6 with the left forearm contusion he took off a Juan Soto line drive; X-rays were negative. Perez carries a 3.54 ERA over 18 appearances and 14 starts. With Waldrep's status now uncertain, getting Perez back on schedule matters more than it did 48 hours ago.", recency: "this-week" },
    ...
    { category: "narrative", title: "The rotation problem has been outscored, not solved", detail: "Atlanta's starters carried a 5.53 ERA across the 31-game stretch in which the club lost 20, averaging under five innings per outing. Sale's seven scoreless on Friday and Elder's six on Monday are two data points against that, not a trend yet. The Aug. 3 deadline remains the likeliest real fix, with a starter first and an outfield bat second.", recency: "this-week" },
    { category: "milestone", title: "Sale sits 71 strikeouts from Frank Tanana", detail: "The fourth of his six strikeouts in Friday's 15-1 win was No. 2,700 of his career, in an outing where no Texas runner reached third base. He is 10-6 with a 2.06 ERA over 18 starts and holds the strongest NL Cy Young case in the league. He closes the San Diego series Thursday afternoon.", recency: "this-week" },
